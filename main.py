...
if __name__ == '__main__':
    ...
    ax.set_xlabel(get_display("Error (meters)"), fontweight='bold', fontsize='large')
    ax.set_ylabel(get_display("Number of samples"), fontweight='bold', fontsize='large')
    ax.grid(True)
    plt.tight_layout()
    ...
    ax.set_xlabel(get_display("Distance Threshold (meters)"), fontweight='bold', fontsize='large')
    ax.set_ylabel(get_display("Prediction Accuracy (%)"), fontweight='bold', fontsize='large')
    ax.grid(True)
    plt.tight_layout()
    ...
    ax.scatter(Y_test[:100, 0], Y_test[:100, 1], label=get_display("Actual value"), c='#0066b3', alpha=0.6)
    ax.scatter(Y_pred[:100, 0], Y_pred[:100, 1], label=get_display("Predicted value"), c='#e60049', alpha=0.6)
    ...
    ax.set_xlabel(get_display("X Position"), fontweight='bold', fontsize='large')
    ax.set_ylabel(get_display("Y Position"), fontweight='bold', fontsize='large')
    ax.grid(True)
    plt.tight_layout()
